...
const Mentor_Card = ({mentor}) => {
  return (
    <div className='w-full md:w-[20%] lg:w-[20%] flex flex-col items-center p-5 text-center hover:shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] rounded-2xl hover:cursor-pointer hover:scale-110 transition-all duration-200 ease-in-out group'>
